...
def update_screen(ai_settings, screen, stats, sb, ship, aliens, bullets, play_button, live):
    """Обновляет изображения на экране и отображает новый экран."""
    #При каждом переходе цикла перерисовыется экран.
